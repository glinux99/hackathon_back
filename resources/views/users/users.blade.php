    ...
    <div class="card" data-select2-id="select2-data-156-v9nn">
        ...
        <div class="card-body py-4">
            ...
            ">
                                ...
                                <th class="min-w-75px sorting" tabindex="0" aria-controls="fab_table_users" rowspan="1"
                                    colspan="1" style="width: 100px;"
                                    aria-label="Role: activate to sort column ascending">Role</th>
                                <th class="min-w-85px sorting" tabindex="0" aria-controls="fab_table_users" rowspan="1"
                                    colspan="1" style="width: 85px;"
                                    aria-label="Connexion: activate to sort column ascending">Connexion</th>

                                <th class="sorting min-w-100px " tabindex="0" aria-controls="fab_table_users"
