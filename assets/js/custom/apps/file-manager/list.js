...
var KTFileManagerList = (function () {
    ...
    const l = () => {
        ...
        i = () => {
            ...
            "folders" === t.getAttribute("data-kt-filemanager-table") &&
                (o = document.querySelectorAll(
                    '#fab_file_manager_list_wrapper [type="checkbox"]'
                ));
        ...
        c = () => {
            const e = t.querySelector("#fab_file_manager_new_folder_row");
        ...
        u = (o) => {
            ...
            if (
                (o.preventDefault(),
                t.querySelectorAll("#fab_file_manager_rename_input").length > 0)
            )
            ...
            (s.querySelector("#fab_file_manager_rename_folder_icon").innerHTML =
                i.outerHTML),
                (l.innerHTML = s.innerHTML),
                (a.querySelector("#fab_file_manager_rename_input").value = r);
            ...
            document
                .querySelector("#fab_file_manager_rename_folder")
            ...
            const d = document.querySelector(
                "#fab_file_manager_rename_folder_cancel"
            );
        ...
        f = () => {
            document.getElementById(
                "fab_file_manager_items_counter"
            ).innerText = e.rows().count() + " items";
        };
    return {
        init: function () {
            (t = document.querySelector("#fab_file_manager_list")) &&
                ((o = document.querySelector(
                ...
                l(),
                document
                    .getElementById("fab_file_manager_new_folder")
                    .addEventListener("click", (n) => {
                        if (
                            (n.preventDefault(),
                            t.querySelector("#fab_file_manager_new_folder_row"))
                        )
                            return;
                        ...
                        const s = i.querySelector(
                                "#fab_file_manager_add_folder_form"
                            ),
                            d = i.querySelector("#fab_file_manager_add_folder"),
                            u = i.querySelector(
                                "#fab_file_manager_cancel_folder"
                            ),
                            m = i.querySelector(
                                "#fab_file_manager_folder_icon"
                            ),
                ...
                (() => {
                    const e = "#fab_modal_upload_dropzone",
                ...
                (() => {
                    const e = document.querySelector(
                            "#fab_modal_move_to_folder"
                        ),
                        t = e.querySelector("#fab_modal_move_to_folder_form"),
                        o = t.querySelector("#fab_modal_move_to_folder_submit"),
