...
var KTAppEcommerceSaveCategory = (function () {
    const e = () => {
            $("#fab_ecommerce_add_category_conditions").repeater({
                initEmpty: !1,
    ...
    return {
        init: function () {
            [
                "#fab_ecommerce_add_category_description",
                "#fab_ecommerce_add_category_meta_description",
            ].forEach((e) => {
                ...
                ["#fab_ecommerce_add_category_meta_keywords"].forEach((e) => {
                ...
                (() => {
                    const e = document.getElementById(
                            "fab_ecommerce_add_category_status"
                        ),
                        t = document.getElementById(
                            "fab_ecommerce_add_category_status_select"
                        ),
                    ...
                    const a = document.getElementById(
                        "fab_ecommerce_add_category_status_datepicker"
                    );
                    $(
                        "#fab_ecommerce_add_category_status_datepicker"
                ...
                (() => {
                    ...
                    const t = document.getElementById(
                            "fab_ecommerce_add_category_form"
                        ),
                        o = document.getElementById(
                            "fab_ecommerce_add_category_submit"
                        );
