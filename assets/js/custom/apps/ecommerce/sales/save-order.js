...
var KTAppEcommerceSalesSaveOrder = (function () {
    ...
    return {
        init: function () {
            (() => {
                $("#fab_ecommerce_edit_order_date").flatpickr({
                    altInput: !0,
                    altFormat: "d F, Y",
                    dateFormat: "Y-m-d",
                });
                ...
                $("#fab_ecommerce_edit_order_billing_country").select2({
                    placeholder: "Select a country",
                    minimumResultsForSearch: 1 / 0,
                    templateSelection: r,
                    templateResult: r,
                }),
                    $("#fab_ecommerce_edit_order_shipping_country").select2({
                        placeholder: "Select a country",
                        minimumResultsForSearch: 1 / 0,
                        templateSelection: r,
                        templateResult: r,
                    ...
                    (e = document.querySelector(
                        "#fab_ecommerce_edit_order_product_table"
                    )),
                    (t = $(e).DataTable({
                        order: [],
                        scrollY: "400px",
                ...
                (() => {
                    const e = document.getElementById(
                        "fab_ecommerce_edit_order_shipping_form"
                    );
                    document
                ...
                (() => {
                    const t = e.querySelectorAll('[type="checkbox"]'),
                        r = document.getElementById(
                            "fab_ecommerce_edit_order_selected_products"
                        ),
                        o = document.getElementById(
                            "fab_ecommerce_edit_order_total_price"
                        );
                    t.forEach((e) => {
                ...
                (() => {
                    ...
                    const t = document.getElementById(
                            "fab_ecommerce_edit_order_form"
                        ),
                        r = document.getElementById(
                            "fab_ecommerce_edit_order_submit"
                        );
