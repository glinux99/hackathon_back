    ...
    return {
        init: function () {
            (t = document.querySelector(
                "#fab_ecommerce_report_returns_table"
            )) &&
                ...
                (() => {
                    var t = moment().subtract(29, "days"),
                        e = moment(),
                        r = $("#fab_ecommerce_report_returns_daterangepicker");
                    function n(t, e) {
                        r.html(
                ...
                (() => {
                    ...
                    new $.fn.dataTable.Buttons(t, {
                        ...
                        .container()
                        .appendTo($("#fab_ecommerce_report_returns_export")),
                        document
                            .querySelectorAll(
                                "#fab_ecommerce_report_returns_export_menu [data-kt-ecommerce-export]"
                            )
                            .forEach((t) => {
