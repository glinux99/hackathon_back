...
var KTAppEcommerceSettings = {
    init: function () {
        [
            "fab_ecommerce_settings_general_form",
            "fab_ecommerce_settings_general_store",
            "fab_ecommerce_settings_general_localization",
            "fab_ecommerce_settings_general_products",
            "fab_ecommerce_settings_general_customers",
        ].forEach((e) => {
