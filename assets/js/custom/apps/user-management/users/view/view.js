...
var KTUsersViewMain = {
    init: function () {
        document
            .getElementById("fab_modal_sign_out_sesions")
            ...
            document
                .getElementById("fab_users_delete_two_step")
                .addEventListener("click", (t) => {
                    t.preventDefault(),
                        Swal.fire({
            ...
            (() => {
                const t = document.getElementById(
                        "fab_users_email_notification_form"
                    ),
                    n = t.querySelector("#fab_users_email_notification_submit"),
                    e = t.querySelector("#fab_users_email_notification_cancel");
