...
var KTUsersAddSchedule = (function () {
    const t = document.getElementById("fab_modal_add_schedule"),
        e = t.querySelector("#fab_modal_add_schedule_form"),
        n = new bootstrap.Modal(t);
    return {
        init: function () {
            (() => {
                $("#fab_modal_add_schedule_datepicker").flatpickr({
                    enableTime: !0,
                    dateFormat: "Y-m-d H:i",
                });
                const o = e.querySelector("#fab_modal_add_schedule_tagify");
                new Tagify(o, {
                    whitelist: [
                        "sean@dellito.com",
                        "brian@exchange.com",
