...
var KTAppCalendar = (function () {
    ...
    const x = () => {
            ...
            const o = f.querySelectorAll('[data-kt-calendar="datepicker"]'),
                i = f.querySelector("#fab_calendar_datepicker_allday");
                ...
                o.preventDefault(),
                    ...
                    (() => {
                        ...
                        const o = f.querySelectorAll(
                            ...
                            i = f.querySelector(
                                "#fab_calendar_datepicker_allday"
                            );
                        i.addEventListener("click", (e) => {
                            e.target.checked
                                ? o.forEach((e) => {
        ...
        C = () => {
            ...
            l.setDate(e, !0, "Y-m-d");
            const o = f.querySelector("#fab_calendar_datepicker_allday"),
    ...
    return {
        init: function () {
            const C = document.getElementById("fab_modal_add_event");
            (f = C.querySelector("#fab_modal_add_event_form")),
                ...
                (o = f.querySelector("#fab_calendar_datepicker_start_date")),
                (i = f.querySelector("#fab_calendar_datepicker_end_date")),
                (d = f.querySelector("#fab_calendar_datepicker_start_time")),
                (s = f.querySelector("#fab_calendar_datepicker_end_time")),
                (y = document.querySelector('[data-kt-calendar="add"]')),
                (D = f.querySelector("#fab_modal_add_event_submit")),
                (k = f.querySelector("#fab_modal_add_event_cancel")),
                (_ = C.querySelector("#fab_modal_add_event_close")),
                (v = f.querySelector('[data-kt-calendar="title"]')),
                (u = new bootstrap.Modal(C));
            const H = document.getElementById("fab_modal_view_event");
            var F, O, I, R, V, P;
            (w = new bootstrap.Modal(H)),
                ...
                (L = H.querySelector("#fab_modal_view_event_edit")),
                (E = H.querySelector("#fab_modal_view_event_delete")),
                (F = document.getElementById("fab_calendar_app")),
