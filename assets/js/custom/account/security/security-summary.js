...
var KTAccountSecuritySummary = (function () {
    ...
    return {
        init: function () {
            t(
                "#fab_security_summary_tab_hours_agents",
                "#fab_security_summary_chart_hours_agents",
                [50, 70, 90, 117, 80, 65, 80, 90, 115, 95, 70, 84],
                [50, 70, 90, 117, 80, 65, 70, 90, 115, 95, 70, 84],
                !0
            ),
                t(
                    "#fab_security_summary_tab_hours_clients",
                    "#fab_security_summary_chart_hours_clients",
                    [50, 70, 90, 117, 80, 65, 80, 90, 115, 95, 70, 84],
                    [50, 70, 90, 117, 80, 65, 80, 90, 115, 95, 70, 84],
                    !1
                ),
                t(
                    "#fab_security_summary_tab_day",
                    "#fab_security_summary_chart_day_agents",
                    [50, 70, 80, 100, 90, 65, 80, 90, 115, 95, 70, 84],
                    [50, 70, 90, 117, 60, 65, 80, 90, 100, 95, 70, 84],
                    !1
                ),
                t(
                    "#fab_security_summary_tab_day_clients",
                    "#fab_security_summary_chart_day_clients",
                    [50, 70, 100, 90, 80, 65, 80, 90, 115, 95, 70, 84],
                    [50, 70, 90, 115, 80, 65, 80, 90, 115, 95, 70, 84],
                    !1
                ),
                t(
                    "#fab_security_summary_tab_week",
                    "#fab_security_summary_chart_week_agents",
                    [50, 70, 75, 117, 80, 65, 80, 90, 115, 95, 50, 84],
                    [50, 60, 90, 117, 80, 65, 80, 90, 115, 95, 70, 84],
                    !1
                ),
                t(
                    "#fab_security_summary_tab_week_clients",
                    "#fab_security_summary_chart_week_clients",
