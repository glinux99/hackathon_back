...
var KTModalOfferADeal = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#fab_modal_offer_a_deal_stepper")),
                (o = document.querySelector("#fab_modal_offer_a_deal_form")),
                (t = new KTStepper(e));
        },
        getStepper: function () {
            return e;
...
KTUtil.onDOMContentLoaded(function () {
    document.querySelector("#fab_modal_offer_a_deal") &&
