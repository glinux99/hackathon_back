...
var KTModalNewTarget = (function () {
    ...
    return {
        init: function () {
            (i = document.querySelector("#fab_modal_new_target")) &&
                ((o = new bootstrap.Modal(i)),
                (a = document.querySelector("#fab_modal_new_target_form")),
                (t = document.getElementById("fab_modal_new_target_submit")),
                (e = document.getElementById("fab_modal_new_target_cancel")),
