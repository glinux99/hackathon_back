...
var KTSignupComingSoon = (function () {
    ...
    return {
        init: function () {
            var s, l, u;
            (e = document.querySelector("#fab_coming_soon_form")),
                (t = document.querySelector("#fab_coming_soon_submit")),
                e &&
                ...
                (n = document.querySelector("#fab_coming_soon_counter_days")) &&
                    ((i = document.querySelector(
                        "#fab_coming_soon_counter_hours"
                    )),
                    (r = document.querySelector(
                        "#fab_coming_soon_counter_minutes"
                    )),
                    (a = document.querySelector(
                        "#fab_coming_soon_counter_seconds"
                    )),
                    (s = new Date()),
