...
var KTAppLayoutBuilder = (function () {
    ...
    return {
        init: function () {
            var d, c, m;
            ((a = document.querySelector("#fab_app_engage")),
            (s = document.querySelector("#fab_app_engage_toggle_on")),
            (l = document.querySelector("#fab_app_engage_toggle_off")),
            (u = document.querySelector("#fab_app_engage_prebuilts_modal")),
            a &&
                u &&
                (null !== u &&
                    "1" !==
                    ...
                    KTUtil.on(u, "[data-kt-mode]", "click", function (n) {
                        const i = this.innerText,
                            ...
                            a = document.querySelector(
                                "#fab_app_engage_prebuilts_view_image"
                            ),
                            l = document.querySelector(
                                "#fab_app_engage_prebuilts_view_text"
                            );
                        (e.innerText = i),
            ...
            (e = document.querySelector("#fab_app_layout_builder_form"))) &&
                ((n = e.getAttribute("action")),
                (t = document.querySelector("#fab_app_layout_builder_action")),
                (i = document.querySelector("#fab_app_layout_builder_preview")),
                (r = document.querySelector("#fab_app_layout_builder_export")),
                (o = document.querySelector("#fab_app_layout_builder_reset")),
                i &&
                ...
                (d = document.querySelector(
                    "#fab_layout_builder_theme_mode_light"
                )),
                (c = document.querySelector(
                    "#fab_layout_builder_theme_mode_dark"
                )),
                (m = document.querySelector(
                    "#fab_layout_builder_theme_mode_" + KTThemeMode.getMode()
                )),
                d &&
...
var KTLayoutSearch = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#fab_header_search")) &&
...
var KTLayoutAside = {
    init: function () {
        var e, t;
        document.querySelector("#fab_aside") &&
            ((e = document.querySelector(
                '[data-kt-toggle-name="aside-minimize"]'
            )),
            (t = KTToggle.getInstance(e)),
            document
                .querySelectorAll('#fab_aside_nav [data-bs-toggle="tab"]')
                .forEach((e) => {
                    new bootstrap.Tab(e),
...
var KTLayoutHeader = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#fab_header")),
                (function () {
                    if (e) {
