    ...
    return {
        init: function () {
            ...
            !(function () {
                ...
                (s = document.getElementById("fab_project_overview_graph")),
                ...
                (function () {
                    ...
                    const e = $(t).DataTable({ info: !1, order: [] }),
                        a = document.getElementById("fab_filter_orders"),
                        r = document.getElementById("fab_filter_year");
                    var o, n;
                    a.addEventListener("change", function (t) {
                        ...
                        document
                            .getElementById("fab_filter_search")
