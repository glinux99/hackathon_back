...
var KTModalUpdateAddress = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#fab_modal_update_address")),
                (i = new bootstrap.Modal(t)),
                (r = t.querySelector("#fab_modal_update_address_form")),
                (e = r.querySelector("#fab_modal_update_address_submit")),
                (n = r.querySelector("#fab_modal_update_address_cancel")),
                (o = t.querySelector("#fab_modal_update_address_close")),
