...
var KTCustomersExport = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#fab_customers_export_modal")),
                (a = new bootstrap.Modal(t)),
                (i = document.querySelector("#fab_customers_export_form")),
                (e = i.querySelector("#fab_customers_export_submit")),
                (n = i.querySelector("#fab_customers_export_cancel")),
                (o = t.querySelector("#fab_customers_export_close")),
