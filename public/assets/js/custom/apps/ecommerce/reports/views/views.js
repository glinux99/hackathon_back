...
var KTAppEcommerceReportViews = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#fab_ecommerce_report_views_table")) &&
                ((e = $(t).DataTable({ info: !1, order: [], pageLength: 10 })),
                (() => {
                    var t = moment().subtract(29, "days"),
                        e = moment(),
                        r = $("#fab_ecommerce_report_views_daterangepicker");
                    function o(t, e) {
                        r.html(
                ...
                (() => {
                    ...
                    new $.fn.dataTable.Buttons(t, {
                        ...
                        .container()
                        .appendTo($("#fab_ecommerce_report_views_export")),
                        document
                            .querySelectorAll(
                                "#fab_ecommerce_report_views_export_menu [data-kt-ecommerce-export]"
                            )
                            .forEach((t) => {
