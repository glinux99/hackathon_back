...
var KTSubscriptionsProducts = (function () {
    ...
    return {
        init: function () {
            (n = document.getElementById("fab_modal_add_product")),
                (o = new bootstrap.Modal(n)),
                (t = document.querySelector(
                    "#fab_subscription_products_table"
                )),
                (e = $(t).DataTable({
                    info: !1,
                    order: [],
                ...
                (function () {
                    n.querySelector("#fab_modal_add_product_close");
                    const r = n.querySelector("#fab_modal_add_product_cancel"),
                        c = n.querySelector("#fab_modal_add_product_submit");
