...
var KTProfileGeneral = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#fab_followers_show_more_button")),
                (e = document.querySelector("#fab_followers_show_more_cards")),
                (i = document.querySelector("#fab_user_follow_button")),
                (o = document.querySelector("#fab_user_profile_nav")),
                t &&
