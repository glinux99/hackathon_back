...
var KTModalCreateProject = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#fab_modal_create_project_stepper")),
                (o = document.querySelector("#fab_modal_create_project_form")),
                (t = new KTStepper(e));
        },
...
KTUtil.onDOMContentLoaded(function () {
    document.querySelector("#fab_modal_create_project") &&
