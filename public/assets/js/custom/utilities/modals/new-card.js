...
var KTModalNewCard = (function () {
    ...
    return {
        init: function () {
            (i = document.querySelector("#fab_modal_new_card")) &&
                ((o = new bootstrap.Modal(i)),
                (r = document.querySelector("#fab_modal_new_card_form")),
                (t = document.getElementById("fab_modal_new_card_submit")),
                (e = document.getElementById("fab_modal_new_card_cancel")),
