...
var KTCreateCampaign = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#fab_modal_create_campaign")) &&
                (new bootstrap.Modal(e),
                (t = document.querySelector(
                    "#fab_modal_create_campaign_stepper"
                )),
                (a = document.querySelector(
                    "#fab_modal_create_campaign_stepper_form"
                )),
                ...
                (function () {
                    var e = document.querySelector(
                            "#fab_modal_create_campaign_age_slider"
                        ),
                        t = document.querySelector(
                            "#fab_modal_create_campaign_age_min"
                        ),
                        n = document.querySelector(
                            "#fab_modal_create_campaign_age_max"
                        );
                    noUiSlider.create(e, {
                        start: [18, 40],
                        connect: !0,
                    ...
                    var o = document.querySelector(
                            "#fab_modal_create_campaign_location"
                        ),
                        l = new Tagify(o, {
                            delimiters: null,
                            templates: {
                    ...
                    l.addTags(r),
                        $("#fab_modal_create_campaign_datepicker").flatpickr({
                            altInput: !0,
                            enableTime: !0,
                            altFormat: "F j, Y H:i",
                        ...
                        new Dropzone(
                            "#fab_modal_create_campaign_files_upload",
                            {
                                url: "/",
                                paramName: "file",
                                maxFiles: 10,
                    ...
                    const c = document.querySelector(
                            "#fab_modal_create_campaign_duration_all"
                        ),
                        s = document.querySelector(
                            "#fab_modal_create_campaign_duration_fixed"
                        ),
                        d = document.querySelector(
                            "#fab_modal_create_campaign_datepicker"
                        );
                    [c, s].forEach((e) => {
                    ...
                    var u = document.querySelector(
                            "#fab_modal_create_campaign_budget_slider"
                        ),
                        m = document.querySelector(
                            "#fab_modal_create_campaign_budget_label"
                        );
                    noUiSlider.create(u, {
                        start: [5],
                        connect: !0,
                        ...
                        document
                            .querySelector(
                                "#fab_modal_create_campaign_create_new"
                            )
